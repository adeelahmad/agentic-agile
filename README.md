<div align="center">
  ...
  *Determinism comes from hooks, not model goodwill.*
  ...
  <div align="center">
    <img src="docs/diagrams/workflow.svg" alt="agentic-agile sprint loop: init, human-gated planning (Opus), a Sonnet orchestrator dispatching time-boxed TDD workers (RED, SCAFFOLD, GREEN, REVIEW) in isolated worktrees with hook-enforced gates, final gate with harness-written stats and NEXT.md handoff, clear and repeat; per-attempt time box, state on disk, and the deterministic hook layer. Runs on Claude Code, Codex and OpenCode." width="960">
